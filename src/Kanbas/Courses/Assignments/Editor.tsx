            ...
            <div className=" d-flex wd-flex-row-container justify-content-center align-items-baseline mb-3" >
                ...
                <div className="col-4 col-md-4">
                    <div className="container mt-4 border wd-rounded-corners-all-around wd-border-thin border-secondary form-control" style={{ width: "250px", height: "250px", marginLeft: '0px' }}>
                        ...
                        <div className=" d-flex wd-flex-row-container justify-content-center align-items-center ">
                            <input type="datetime-local" id="wd-due-date" value={`${(assignment[0] && assignment[0].due_date) ? assignment[0].due_date : ``}`} className="form-control" style={{ fontSize: '12px' }} />
                        </div>
                        ...
                        <div className=" d-flex wd-flex-row-container justify-content-center align-items-center ">
                        <input style={{ width: '220px', fontSize: '12px' }} type="datetime-local" id="wd-available-from" value={`${(assignment[0] && assignment[0].available_to) ? assignment[0].available_to : ``}`} className="form-control" />
                        </div>
                        ...
                        <div className=" d-flex wd-flex-row-container justify-content-left align-items-center ">
                        <input style={{ width: '220px', fontSize: '12px' }} type="datetime-local" id="wd-available-until" value={`${(assignment[0] && assignment[0].available_from) ? assignment[0].available_from : ``}`} className="form-control" />
                        </div>
